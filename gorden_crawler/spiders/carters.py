...
class CartersSpider(BaseSpider):
#class CartersSpider(Spider):
    name = "carters"
    ...
    start_urls = [
        'http://www.carters.com/carters-baby-girl?navID=header',
        'http://www.carters.com/carters-baby-boy?navID=header',
        'http://www.carters.com/carters-baby-neutral?navID=header',
        'http://www.carters.com/carters-toddler-girl?navID=header',
        'http://www.carters.com/carters-toddler-boy?navID=header',
        'http://www.carters.com/carters-kid-girl?navID=header',
        'http://www.carters.com/carters-kid-boy?navID=header'
    ]

    url_gender_map = {
        'http://www.carters.com/carters-baby-girl?navID=header' : {'gender': 'baby', 'size_info': 'http://www.carters.com/on/demandware.store/Sites-Carters-Site/default/Page-Include?cid=sc_carters-baby'},
        'http://www.carters.com/carters-baby-boy?navID=header' : {'gender': 'baby', 'size_info': 'http://www.carters.com/on/demandware.store/Sites-Carters-Site/default/Page-Include?cid=sc_carters-baby'},
        'http://www.carters.com/carters-baby-neutral?navID=header': {'gender': 'baby', 'size_info': 'http://www.carters.com/on/demandware.store/Sites-Carters-Site/default/Page-Include?cid=sc_carters-baby'},
        'http://www.carters.com/carters-toddler-girl?navID=header': {'gender': 'toddler', 'size_info': 'http://www.carters.com/on/demandware.store/Sites-Carters-Site/default/Page-Include?cid=sc_carters-toddler'},
        'http://www.carters.com/carters-toddler-boy?navID=header': {'gender': 'toddler', 'size_info': 'http://www.carters.com/on/demandware.store/Sites-Carters-Site/default/Page-Include?cid=sc_carters-toddler'},
        'http://www.carters.com/carters-kid-girl?navID=header': {'gender': 'girls', 'size_info': 'http://www.carters.com/on/demandware.store/Sites-Carters-Site/default/Page-Include?cid=sc_carters-kid-girl'},
        'http://www.carters.com/carters-kid-boy?navID=header': {'gender': 'boys', 'size_info': 'http://www.carters.com/on/demandware.store/Sites-Carters-Site/default/Page-Include?cid=sc_carters-kid-boy'}
    }
    ...
    def parse(self, response):
        ...
        gender = self.url_gender_map[response.url]['gender']
        size_info = self.url_gender_map[response.url]['size_info']
    ...
    def parse_categories(self, response):
        ...
        for li in uri_categories_lis:
            url=li.xpath('.//div[@class="product-name"]/h2/a/@href').extract()[0]

            if not re.match(r'^http:', url):
                url = 'http://www.carters.com' + url
            ...
            item['url']=url
            item['current_price']=li.xpath('.//span[contains(@class, "product-sales-price")]/text()').extract()[0]
...
#             item['desc']=".".join(sel.xpath('//div[contains(@class, "additional")]/ul/li/text()').extract())
            ...
            if sel.xpath('//div[contains(@class, "quantity clearfix")]//p[contains(@class, "in-stock-msg")]/text()'):
                ...
                for item_color_link in item_colors_links:
                    ...
                    for item_size in item_sizes:
                        ...
                        skuItem['id']=item['show_product_id']+"*"+item_size
