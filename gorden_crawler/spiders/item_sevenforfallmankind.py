...
from gorden_crawler.spiders.sevenforallmankind import AllmankindSpider

class ItemAllmankindSpider(ItemSpider):
    name = "item_sevenforallmankind"
    allowed_domains = ["7forallmankind.com"]
...
#         }
    ...
    def parse(self, response):
        ...
        sfas = AllmankindSpider()
        
        return sfas.handle_parse_item(response, item)