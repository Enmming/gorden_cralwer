...
class Taiwan(BaseCountry):
	...
	def parse_country(self):
		place_lis = self.sel.xpath('//div[contains(@class, "column column-alpha")]/ul')[0].xpath('.//ul/li')
		place_lis_temp = self.sel.xpath('//div[contains(@class, "column column-alpha")]/ul')[1].xpath('.//li')[0].xpath('.//ul/li')
