...
class Canada(BaseCountry):
	...
	def parse_country(self):
		place_lis = self.sel.xpath('//div[contains(@class, "column column-alpha")]/ul')[0:4].xpath('.//ul[@class="cities"]/li')
		place_lis_temp = self.sel.xpath('//div[contains(@class, "column column-alpha")]/ul')[4].xpath('./li')[0].xpath('.//li')
